...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN -1 //was HEATER_3_PIN// Set a custom pin for the controller fan
 ...
 */
#define E0_AUTO_FAN_PIN -1 //AFM was FAN2_PIN
...
//#define EXT_SOLENOID   //THIS NEEDS TO BE DEFINED FOR M380/M381
...
#define BEEP_ON_FEEDRATE_CHANGE //AFM new beep
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR 20         //was 8  Babysteps are very small. Increase for faster motion.
...
// @section leveling
  ...
  //#define MESH_MIN_X 270 			//was MESH_INSET   //Note though that (unlike bilinear leveling) the MESH_MIN and 
  //#define MESH_MIN_Y MESH_INSET  	//MESH_MAX positions refer to where the nozzle can reach, not the probe.
 ...
 */
//#define G29_RETRY_AND_RECOVER // off for UBL! 
...
#define ADVANCED_OK  //AFM enabled to test reliability with octopi connection!
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         33  // (mm) Length to extrude after loading.
 ...
 */
#if HAS_TRINAMIC       // AFM Setting for Trinamic TMC2660
   ...
   */
  #define X_CS_PIN          P0_10 //-1
  #define Y_CS_PIN          P0_19 //-1
  #define Z_CS_PIN          P0_21 //-1
  //#define X2_CS_PIN         //-1
  //#define Y2_CS_PIN         //-1
  //#define Z2_CS_PIN         //-1
  //#define Z3_CS_PIN         //-1
  #define E0_CS_PIN         P0_04 //-1
  #define E1_CS_PIN         P4_29 //-1
  //#define E2_CS_PIN         //-1
  //#define E3_CS_PIN         //-1
  //#define E4_CS_PIN         //-1
  //#define E5_CS_PIN         //-1
  ...
  #define TMC_SW_MOSI     P0_18//  MOSI //was -1  values from LPC1769 documentation! AFM
  #define TMC_SW_MISO     P0_17//  MISO //was -1
  #define TMC_SW_SCK      P0_15//  SCK  //was -1
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V //AFM this is new! my old config
  //was ((#define CHOPPER_TIMING))={ 4, -2, 1}  //(Off, Hend, Hstart)-1
  //AFM from TMC2660-PA datasheet states hysteresis end= 0-2 (0-15) ; hysteresis start= 0-7 ; hysteresis dec (or OFF TIME)= 0-3 !
   ...
   */
  //#define HYBRID_THRESHOLD //AFM off for tmc2660
 ...
 */
//#define SPINDLE_LASER_ENABLE  //Don't use! go simple(FAN2 pwm) use: M106 P1 S255 new laser Engraver AFM!
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Home & Level Bed"
  #define USER_GCODE_1 "G28 X0 Y0 Z0\nG29 W"
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_SUPPORT //AFM Octopi supports it! I added below!
  #define ACTION_ON_KILL "disconnect"
