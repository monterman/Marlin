...
#define FAN2_PIN           P1_23  // For LASER engraver! 2nd fan output attached to laser TTL input
//
// Display
//
...
// Solenoid  - Magnetic Solenoid Pins AFM
//
#define SOL0_PIN          P1_09  // LEFT EXTRUDER E0 - RELAY N1
#define SOL1_PIN          P1_10  // RIGHT EXTRUDER E1 - RELAY N2

// Filament runout define digital pin 4 for the filament runout sensor. Use the RAMPS 1.4 digital input 4 on the servos connector
#ifndef FIL_RUNOUT_PIN
  #define FIL_RUNOUT_PIN   P1_01  //  Extruder T0 - 1
  #define FIL_RUNOUT_PIN2  P1_04  //  Extruder T1 - 2
#endif
//Laser Spindel pins http://marlinfw.org/docs/configuration/laser_spindle.html
//#define FAN2_PIN           P1_23  // For LASER engraver! 2nd fan output attached to laser TTL input
//#define SPINDLE_LASER_ENA_PIN    P1_27   // digital pin
//#define SPINDLE_LASER_PWM_PIN    -1   // digital pin - MUST BE HARDWARE PWM
